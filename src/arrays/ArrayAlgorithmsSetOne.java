 ...
 * 4. All pairs who sum is given number
 * 5. Pairs whose sum is even in two array
 * 6. Pairs whose sum is odd in two array
 * 7. Pairs whose sum is odd, a number cannot repeat
 * 8. Removing duplicate elements from array
 * 9. Kth smallest element in unsorted arrat
 * 10.Kth largest element in sorted arrat
 * 11.Common element in three sorted arrat
 * 12.Find first repeating element
 * 13.First three largest element in array
 * 14.All sub array whose sum is 0
 */
public class ArrayAlgorithmsSetOne {
